...
public class DeviceServiceImpl implements DeviceService {
    ...
    private volatile StreamingService streamingService;
    ...
    public void setName(String name) {
        ...
        Device device = deviceDAO.createDevice(name, mac);        
        
        streamingService.startStreaming(device.getUser().asAnonUser());
    }
