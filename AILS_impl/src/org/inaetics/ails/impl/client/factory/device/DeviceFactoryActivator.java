 ...
 * @since 05-11-2015
 */
public class DeviceFactoryActivator extends DependencyActivatorBase {

    @Override
    public void init(BundleContext context, DependencyManager dm) throws Exception {
        dm.add(createComponent().setInterface(DeviceFactory.class.getName(), null)
                .setImplementation(DeviceFactoryImpl.class));
    }
