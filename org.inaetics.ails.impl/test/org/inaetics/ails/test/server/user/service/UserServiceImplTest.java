...
public class UserServiceImplTest {
    ...
    public void testFindUnknownUUID() {
        ...
        when(userDataStore.getUser(any(UUID.class))).thenReturn(absentUser);
    ...
    public void testLocateUnknownUUID() {
        // Mocks need to return Optional.empty, not null (their default)
        Optional<Location> absentLocation = Optional.absent();
        when(locationProvider.locate(any(UUID.class))).thenReturn(absentLocation);
